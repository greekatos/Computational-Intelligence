...
for i, (train, test) in enumerate(kfold.split(X_tr)):
    model = Sequential()
    # Input Layer
    model.add(Dense(784,, activation='relu', input_dim=784))#k
    ...
    model.compile(loss='mean_squared_error', optimizer=p, metrics=['accuracy'])#mean_squared_error,sparse_categorical_crossentropy
